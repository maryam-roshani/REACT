    ...
    return (
        <div className="bg-slate-50 flex justify-content-center align-items-center w-full h-full">
            <div className="w-96 h-48 rounded-md bg-white p-5 m-auto relative">
                ...
                <span className=" absolute rotate-45 top-5 -right-11 text-lg trapezoid"><p className="top-2 left-4 absolute">{task.status}</p></span>
                <p className="text-right p-3 my-2">{timeDistance}</p>
            </div>
        </div>
    )
}
